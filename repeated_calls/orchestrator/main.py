...
async def run_sequence() -> None:
    ...
    get_customer_context_step.on_event("FetchingContextDone").send_event_to(determine_repeated_caller_step, function_name="repeated_call", parameter_name="callstate")
