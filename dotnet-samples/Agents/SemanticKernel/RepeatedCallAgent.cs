...
namespace cw_repeated_calls_dotnet.Agents.SemanticKernel
{
    public class RepeatedCallAgent : IAgent<RepeatedCallResult>
    {
        public async Task<RepeatedCallResult> GetAgentResponseAsync(Kernel kernel, RepeatedCallState state)
        {
            ...
            ChatCompletionAgent causeAgent = CreateAgent(kernel, "RepeatedCallAgent", prompts.SystemPrompt);
            ...
            var formattedResponse = JsonSerializer.Deserialize<RepeatedCallResult>(response.Content!.ToString());
                ...
                new ChatCompletionAgent()
                {
                    ...
                    Arguments = new KernelArguments(
                        new OpenAIPromptExecutionSettings()
                        {
                            ...
                            ResponseFormat = typeof(RepeatedCallResult)
                        })
                };
